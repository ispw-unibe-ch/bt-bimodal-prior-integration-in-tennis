...
p
ggsave(filename = "plots/all_subjects_day2_and_day3.png", plot = p, width = 17, height = 13)
ggsave(filename = "plots/all_subjects_day2_and_day3.svg", plot = p, width = 17, height = 13)
